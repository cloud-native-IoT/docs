...
Example : mosquitto_pub --cafile cert.pem --cert test.crt --key test.key  -t “devices/{device_id}/state/reported/delta" -h mqtt.api.recasta.cloud  --tls-version tlsv1.2 -d -p 8883 -m "{\"ping\": \"test\”}"
